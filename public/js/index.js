...
var radius = 300; // Độ rộng vòng xoay
...
var imgHeight = 200; // độ cao ảnh (tính theo px)

// Link nhạc nền - cho bằng null nếu không muốn nhạc nền
var bgMusicURL = false;
...
window.onload = function() {
  var elements = document.getElementsByClassName('typewrited');
  ...
  css.type = "text/css";
  css.innerHTML = ".typewrited > .wrap {color:white}";
